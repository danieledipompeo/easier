...
mvn install:install-file -Dfile=org.eclipse.papyrus.marte.static.profile_1.2.3.202303241341.jar -DgroupId=it.univaq.disim.sealab.uml.profiles -DartifactId=org.eclipse.papyrus.marte.static.profile -Dversion=1.2.3.202303241341 -Dpackaging=jar
