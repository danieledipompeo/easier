...
//    protected final SolutionListEvaluator<S> solutionListEvaluator = new SequentialSolutionListEvaluator<>();
    ...
    public void updateProgressTest() throws IOException, EasierException, EasierObjectiveNotFoundException {
    ...
    private List<S> createFakePopulation(int numElement) throws EasierException, EasierObjectiveNotFoundException {
